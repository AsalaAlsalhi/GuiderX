      ...
      <div className="p-4">
        ...
        <div className="mt-4 grid grid-cols-2 gap-3">
          <Link
            ...
            className="h-11 rounded-2xl border border-[var(--brand-green)]/15 bg-white text-[var(--brand-green)] font-semibold hover:bg-[var(--brand-cream)] transition flex items-center justify-center"
          >
            Details
          </Link>

          <Link
            href={`/book?trip=${encodeURIComponent(id)}`}
            className="h-11 rounded-2xl bg-[var(--brand-gold)] text-white font-semibold hover:opacity-95 transition flex items-center justify-center"
          >
            Book
          </Link>
        </div>
